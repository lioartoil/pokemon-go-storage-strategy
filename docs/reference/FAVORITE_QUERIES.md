...
| 19 | `Kept` | `#Kept` | Permanent collection |
...
| # | Name | Query | Purpose |
|---|------|-------|---------|
| 20 | `Mega-1st` | `megaevolve&#Rank1&mega0&#Mega` | Best IVs, not mega evolved |
| 21 | `Mega-Lvl` | `megaevolve&#Rank1&mega1&#Mega` | Best IVs, mega level 1 |
| 22 | `Mega` | `megaevolve&#Mega` | All mega candidates |
...
| # | Name | Query | Purpose |
|---|------|-------|---------|
| 23 | `GL-Top` | `#Great&#Rank1,#Rank2,#Rank3` | Great League top 3 |
| 24 | `UL-Top` | `#Ultra&#Rank1,#Rank2,#Rank3` | Ultra League top 3 |
| 25 | `LL-Top` | `#Little&#Rank1,#Rank2,#Rank3` | Little League top 3 |
| 26 | `Global-Best` | `#First,#Second,#Third` | Trophy Pokemon (#1-3 IVs) |
| 27 | `Raid` | `#Attackers` | Raid attackers |
| 28 | `Defense` | `#Def1,#Def2,#Def2.5` | Gym defenders |
...
| # | Name | Query | Purpose |
|---|------|-------|---------|
| 29 | `Evo-Special` | `#SpecialEvolve` | Special evolution method |
| 30 | `Evo-Item` | `#ItemEvolve` | Needs evolution item |
| 31 | `Evo-Location` | `#LocationEvolve` | Needs location |
| 32 | `Evo-Time` | `#TimeEvolve` | Needs time/weather |
...
| # | Name | Query | Purpose |
|---|------|-------|---------|
| 33 | `Buddy-1km` | `#Buddy1Km&#NeedCandy` | 1km buddy candy claims |
| 34 | `Buddy-3km` | `#Buddy3Km&#NeedCandy` | 3km buddy candy claims |
| 35 | `Buddy-5km` | `#Buddy5Km&#NeedCandy` | 5km buddy candy claims |
| 36 | `Buddy-20km` | `#Buddy20Km&#NeedCandy` | 20km buddy candy claims |
| 37 | `Claim Candy` | `#NeedCandy` | All candy claimable |
...
| # | Name | Query | Purpose |
|---|------|-------|---------|
| 38 | `Var1` | `#Var1` | Form variant 1 |
| 39 | `Var2` | `#Var2` | Form variant 2 |
...
## Quick Copy-Paste (All 39 Queries)
...
19. Kept: #Kept
20. Mega-1st: megaevolve&#Rank1&mega0&#Mega
21. Mega-Lvl: megaevolve&#Rank1&mega1&#Mega
22. Mega: megaevolve&#Mega
23. GL-Top: #Great&#Rank1,#Rank2,#Rank3
24. UL-Top: #Ultra&#Rank1,#Rank2,#Rank3
25. LL-Top: #Little&#Rank1,#Rank2,#Rank3
26. Global-Best: #First,#Second,#Third
27. Raid: #Attackers
28. Defense: #Def1,#Def2,#Def2.5
29. Evo-Special: #SpecialEvolve
30. Evo-Item: #ItemEvolve
31. Evo-Location: #LocationEvolve
32. Evo-Time: #TimeEvolve
